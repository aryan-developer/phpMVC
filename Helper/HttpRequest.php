...
class HttpRequest
{
    ...
    public static function post(string $url, array $headers = [], string $data = ''): bool|string
    {
        return self::endpoint($url, true, $headers, $data);
    }

    public static function get(string $url, array $headers = [], string $data = ''): bool|string
    {
